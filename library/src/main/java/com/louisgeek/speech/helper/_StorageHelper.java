...
public class _StorageHelper {
    ...
    public static String getSavePath(String childSavePath) {
        ...
        if (_LogicalExternalStorageHelper.isExternalStorageWritable()) {
            ...
            _LogTool.i(TAG, "模拟外置存储剩余空间:MB: " + _LogicalExternalStorageHelper.getExternalStorageAvailableSpace_MB());
            _LogTool.i(TAG, "模拟外置存储剩余空间:GB: " + _LogicalExternalStorageHelper.getExternalStorageAvailableSpace_GB());
        ...
        if (savePath == null) {
            ...
            _LogTool.i(TAG, "模拟内置存储剩余空间:MB: " + _LogicalInternalStorageHelper.getInternalStorageAvailableSpace_MB());
            _LogTool.i(TAG, "模拟内置存储剩余空间:GB: " + _LogicalInternalStorageHelper.getInternalStorageAvailableSpace_GB());
        ...
        if (savePath == null) {
            ...
            _LogTool.e(TAG, "getSavePath: 存储容量不足" + INSTALL_NEED_LEFT_SPACE_IN_MB + " MB");
        }
        return savePath;
    }
}
